...
class ChecklistCleaningItem {
  ...
  ChecklistCleaningItem copyWith({
    String? idQcItem,
    String? itemName,
    DateTime? dtAprv,
    DateTime? dtAprv2,
  ...
  factory ChecklistCleaningItem.fromMap(Map<String, dynamic> map) {
    return ChecklistCleaningItem(
  ...
  factory ChecklistCleaningItem.fromJson(String source) =>
      ChecklistCleaningItem.fromMap(json.decode(source));

  @override
  String toString() {
    return 'ChecklistCleaningItem(idQcItem: $idQcItem, itemName: $itemName, dtAprv: $dtAprv, dtAprv2: $dtAprv2, dtAprv3: $dtAprv3, statClosing: $statClosing, statClosing2: $statClosing2, statClosing3: $statClosing3, imgLink: $imgLink, imgLink2: $imgLink2, imgLink3: $imgLink3)';
  }
  ...
  bool operator ==(Object other) {
    ...
    return other is ChecklistCleaningItem &&
