...
class Cleaning {
  ...
  factory Cleaning.fromMap(Map<String, dynamic> map) {
    return Cleaning(
      idSite: map['id_site'] ?? '',
  ...
  factory Cleaning.fromJson(String source) =>
      Cleaning.fromMap(json.decode(source));

  @override
  String toString() {
    return 'Cleaning(idSite: $idSite, siteName: $siteName, idCluster: $idCluster, clusterName: $clusterName, idHouse: $idHouse, houseName: $houseName, docId: $docId, qcTransId: $qcTransId)';
  }
