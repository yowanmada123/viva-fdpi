...
class ApprovalSprDetail {
  ...
  factory ApprovalSprDetail.fromMap(Map<String, dynamic> map) {
    return ApprovalSprDetail(
  ...
  factory ApprovalSprDetail.fromJson(String source) =>
      ApprovalSprDetail.fromMap(json.decode(source));

  @override
  String toString() {
    return 'ApprovalSprDetail(docType: $docType, docId: $docId, docCat: $docCat, wDocCat: $wDocCat, idSite: $idSite, idCluster: $idCluster, idHouse: $idHouse, siteName: $siteName, clusterName: $clusterName, houseName: $houseName, dtCreated: $dtCreated, createdBy: $createdBy, dtAprv1: $dtAprv1, aprv1By: $aprv1By, dtAprv2: $dtAprv2, aprv2By: $aprv2By, dtReject: $dtReject, rejectBy: $rejectBy, dtReject2: $dtReject2, reject2By: $reject2By, status: $status, wCreatedBy: $wCreatedBy, wAprv1By: $wAprv1By, wAprv2By: $wAprv2By, wReject1By: $wReject1By, wReject2By: $wReject2By)';
  }
  ...
  bool operator ==(Object other) {
    ...
    return other is ApprovalSprDetail &&
